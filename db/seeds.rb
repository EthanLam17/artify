...
song19 = Song.create(song_title: "The Way Life Goes", album_id: album15.id, song_duration: "03:41")
song19.mp3.attach(io: open('https://s3.amazonaws.com/artify-seeds/the_way_life_goes.mp3'), filename:"the_way_life_goes.mp3")

song20 = Song.create(song_title: "Misunderstood", album_id: album16.id, song_duration: "04:08")
song20.mp3.attach(io: open('https://s3.amazonaws.com/artify-seeds/misunderstood.mp3'), filename:"misunderstood.mp3")

song21 = Song.create(song_title: "NASA", album_id: album17.id, song_duration: "03:02")
song21.mp3.attach(io: open('https://s3.amazonaws.com/artify-seeds/nasa.mp3'), filename:"nasa.mp3")

song22 = Song.create(song_title: "All These Bands", album_id: album18.id, song_duration: "03:04")
